...
public class SafeInput {
    ...
    public static int getInt(@NotNull Scanner pipe, String prompt)
    {
        boolean done = false;
        int retValue = 0;
        String trash = "";
     ...
     */
    public static int getRangedInt(@NotNull Scanner pipe, String prompt, int low, int high)
    {
        boolean done = false;
        int retValue = 0;
        String trash = "";
     ...
     * @return a valid int with no contraints
     */
    public static double getDouble(@NotNull Scanner pipe, String prompt)
    {
        boolean done = false;
        double retValue = 0;
        String trash = "";
     ...
     * @return a valid int with no contraints
     */
    public static double getRangedDouble(@NotNull Scanner pipe, String prompt, double low, double high)
    {
        boolean done = false;
        double retValue = 0;
        String trash = "";
     ...
     */
    public static boolean getYNConfirm(@NotNull Scanner pipe, String prompt)
    {
        String value = "";
     ...
     * @return
     */
    public static String getRegExString(@NotNull Scanner pipe, String prompt, String regEx)
    {
        String retValue = "";
        boolean done = false;
     ...
     */
    public static String getNonZeroLengthString(@NotNull Scanner pipe, String prompt)
    {
        String retValue = "";
        boolean done = false;
